...
HD_PWD='/workspace/logicnets/examples/hgcal_autoencoder/hparams_config_test/pipecleaner/verilog/results_logicnet/vivadocompile/vivadocompile.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log logicnet.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source logicnet.tcl -notrace

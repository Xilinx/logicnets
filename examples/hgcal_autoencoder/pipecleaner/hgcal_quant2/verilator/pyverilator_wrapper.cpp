...
uint32_t get_logicnet__DOT__M0w(Vlogicnet* top, int word){ return top->logicnet__DOT__M0w[word];}
uint64_t get_logicnet__DOT__M1(Vlogicnet* top){return top->logicnet__DOT__M1;}
uint64_t get_logicnet__DOT__M1w(Vlogicnet* top){return top->logicnet__DOT__M1w;}
